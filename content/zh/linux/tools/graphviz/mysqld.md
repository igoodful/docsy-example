...
node [
  fontsize = "10"
    ...
    "node45" [ label = "mysqld", shape = egg ];
    "node1" [ label = "-lpthread", shape = septagon ];
    "node45" -> "node1" [ style = dotted ] // mysqld -> -lpthread
    "node40" [ label = "/usr/local/lib/libicudata.so", shape = septagon ];
    "node45" -> "node40" [ style = dotted ] // mysqld -> /usr/local/lib/libicudata.so
    "node41" [ label = "/usr/local/lib/libicui18n.so", shape = septagon ];
    "node45" -> "node41" [ style = dotted ] // mysqld -> /usr/local/lib/libicui18n.so
    "node42" [ label = "/usr/local/lib/libicuio.so", shape = septagon ];
    "node45" -> "node42" [ style = dotted ] // mysqld -> /usr/local/lib/libicuio.so
    "node43" [ label = "/usr/local/lib/libicuuc.so", shape = septagon ];
    "node45" -> "node43" [ style = dotted ] // mysqld -> /usr/local/lib/libicuuc.so
    "node46" [ label = "binlog", shape = octagon ];
    "node45" -> "node46" [ style = dotted ] // mysqld -> binlog
    "node1" [ label = "-lpthread", shape = septagon ];
    ...
    "node47" [ label = "binlogevents_static", shape = octagon ];
    "node45" -> "node47" [ style = dotted ] // mysqld -> binlogevents_static
    "node67" [ label = "master", shape = octagon ];
    "node45" -> "node67" [ style = dotted ] // mysqld -> master
    "node92" [ label = "minchassis", shape = octagon ];
    "node45" -> "node92" [ style = dotted ] // mysqld -> minchassis
    "node1" [ label = "-lpthread", shape = septagon ];
    "node92" -> "node1"  // minchassis -> -lpthread
    "node6" [ label = "dl", shape = septagon ];
    "node92" -> "node6"  // minchassis -> dl
    "node3" [ label = "mysys", shape = octagon ];
    "node45" -> "node3" [ style = dotted ] // mysqld -> mysys
    "node48" [ label = "rpl", shape = octagon ];
    "node45" -> "node48" [ style = dotted ] // mysqld -> rpl
    "node87" [ label = "slave", shape = octagon ];
    "node45" -> "node87" [ style = dotted ] // mysqld -> slave
    "node64" [ label = "sql_dd", shape = octagon ];
    "node45" -> "node64" [ style = dotted ] // mysqld -> sql_dd
    "node65" [ label = "sql_gis", shape = octagon ];
    "node45" -> "node65" [ style = dotted ] // mysqld -> sql_gis
    "node49" [ label = "sql_main", shape = octagon ];
    "node45" -> "node49" [ style = dotted ] // mysqld -> sql_main
}
