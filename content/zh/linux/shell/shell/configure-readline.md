...
"DUALCASE" [ label = "export DUALCASE=1", shape = octagon ];
"posix" [ label = "set -o posix", shape = octagon ];
"as_nl" [ label = "export as_nl", shape = octagon ];
"IFS" [ label = "IFS PS1 PS2 PS4 LC_ALL LANGUAGE", shape = octagon ];
"BASH_ENV" [ label = "BASH_ENV ENV MAIL MAILPATH CDPATH PATH_SEPARATOR CONFIG_SHELL SHELL CLICOLOR_FORCE GREP_OPTIONS", shape = octagon ];
"as_myself" [ label = "../configure", shape = octagon ];
"as_bourne_compatible" [ label = "兼容性测试shell", shape = octagon ];
"SHELL" [ label = "设置SHELl环境变量", shape = octagon ];
"as_fn_mkdir_p" [ label = "as_fn_unset,as_fn_set_status,as_fn_exit,as_fn_nop,as_fn_mkdir_p", shape = octagon ];
"basename" [ label = "expr basename dirname sed echo ln hostname uname", shape = octagon ];
"ac_option" [ label = "命令行参数解析", shape = octagon ];
"ac_abs_confdir" [ label = "获取源码绝对路径：ac_abs_confdir", shape = octagon ];
"ac_fn_c_try_compile" [ label = "ac_fn_c_try_compile", shape = octagon ];
"ac_fn_c_check_header_compile" [ label = "ac_fn_c_check_header_compile", shape = octagon ];
"ac_fn_c_try_cpp" [ label = "ac_fn_c_try_cpp", shape = octagon ];
"ac_fn_c_check_type" [ label = "ac_fn_c_check_type", shape = octagon ];
"ac_fn_c_try_link" [ label = "ac_fn_c_try_link", shape = octagon ];
"ac_fn_c_check_func" [ label = "ac_fn_c_check_func", shape = octagon ];
"ac_fn_c_try_run" [ label = "ac_fn_c_try_run", shape = octagon ];
"ac_fn_c_check_member" [ label = "ac_fn_c_check_member", shape = octagon ];
"ac_fn_check_decl" [ label = "ac_fn_check_decl", shape = octagon ];
"ac_fn_c_compute_int" [ label = "ac_fn_c_compute_int", shape = octagon ];
"config.log" [ label = "config.log：打印参数列表 ;hostname ;uname -m; uname -r;uname -s;uname -v;uname -p;uname -X;arch;arch -k;getsysinfo;machine;oslevel;universe;PATH", shape = octagon ];
"C89" [ label = "C89", shape = octagon ];
"C99" [ label = "C99", shape = octagon ];
"C11" [ label = "C11", shape = octagon ];
"ac_aux_files" [ label = "config.sub config.guess install-sh", shape = octagon ];
"config.sub" [ label = "checking host system type: config.sub=aarch64-unknown-linux-gnu", shape = octagon ];
"checking" [ label = "checking: make》gcc》stdio.h》stdlib.h》string.h》inttypes.h》stdint.h》sys/stat.h》sys/types.h》unistd.h》wchar.h》minix/config.h》__EXTENSIONS__》_XOPEN_SOURCE》 ", shape = octagon ];
"confdefs.h" [ label = "confdefs.h", shape = octagon ];
"CFLAGS" [ label = "CFLAGS", shape = octagon ];
"grep" [ label = "checking: grep ggrep egrep》install》ar》ranlib", shape = octagon ];
"inline" [ label = "inline》volatile》size_t》ssize_t》stat file-mode macros》dirent.h", shape = octagon ];
"opendir" [ label = "opendir》HAVE_GETTIMEOFDAY", shape = octagon ];
"kill" [ label = "kill》HAVE_LSTAT》HAVE_PSELECT》HAVE_READLINK》HAVE_SELECT》HAVE_SETITIMER》HAVE_MEMMOVE》HAVE_PUTENV》HAVE_SETENV》HAVE_SETLOCALE》HAVE_STRCASECMP》HAVE_STRPBRK》HAVE_SYSCONF》HAVE_TCGETATTR》HAVE_VSNPRINTF》HAVE_ISASCII》HAVE_ISXDIGIT》HAVE_GETPWENT》HAVE_GETPWNAM》HAVE_GETPWUID》HAVE_CHOWN》HAVE_STRCOLL》HAVE_FCNTL_H》HAVE_UNISTD_H》HAVE_STDLIB_H》HAVE_VARARGS_H》HAVE_STDARG_H》HAVE_STDBOOL_H》HAVE_STRING_H》HAVE_STRINGS_H》HAVE_LIMITS_H》HAVE_LOCALE_H》HAVE_PWD_H》HAVE_MEMORY_H》HAVE_TERMCAP_H》HAVE_TERMIOS_H》》HAVE_TERMIO_H》HAVE_SYS_IOCTL_H》HAVE_SYS_PTE_H》HAVE_SYS_STREAM_H》HAVE_SYS_SELECT_H》HAVE_SYS_TIME_H》HAVE_SYS_FILE_H》HAVE_SYS_PTEM_H", shape = octagon ];
"large files" [ label = " large files", shape = octagon ];
"HAVE_POSIX_SIGNALS" [ label = "HAVE_POSIX_SIGNALS: signal.h》HAVE_POSIX_SIGSETJMP》HAVE_LSTAT》HAVE_GETPW_DECLS; sys/ioctl.h》TIOCGWINSZ; HAVE_INTTYPES_H; sys/ioctl.h》TIOCSTAT; sys/ioctl.h》FIONREAD; sys/types.h》speed_t; sys/ioctl.h termios.h》winsize; struct dirent.d_ino》HAVE_STRUCT_DIRENT_D_INO》HAVE_STRUCT_DIRENT_D_FILENO》HAVE_TIMEVAL》HAVE_LIBAUDIT_H》AUDIT_USER_TTY", shape = octagon ];
"termcap" [ label = "tgetent in -ltermcap; checking which library has the termcap functions", shape = octagon ];
"HAVE_LANGINFO_CODESET" [ label = "HAVE_LANGINFO_CODESET", shape = octagon ];
"checking for wctype.h" [ label = "checking for wctype.h: HAVE_WCTYPE_H》HAVE_WCHAR_H》HAVE_LANGINFO_H》", shape = octagon ];
"C11" [ label = "C11", shape = octagon ];
"C11" [ label = "C11", shape = octagon ];
"C11" [ label = "C11", shape = octagon ];
"C11" [ label = "C11", shape = octagon ];
...
"IFS" -> "BASH_ENV"
"BASH_ENV" -> "as_myself"
"as_myself" -> "as_bourne_compatible"
"as_bourne_compatible" -> "SHELL"
"SHELL" -> "as_fn_mkdir_p"
"as_fn_mkdir_p" -> "basename"
"basename" -> "ac_option"
"ac_option" -> "ac_abs_confdir"
"ac_abs_confdir" -> "ac_fn_c_try_compile"
"ac_fn_c_try_compile" -> "ac_fn_c_check_header_compile"
"ac_fn_c_check_header_compile" -> "ac_fn_c_try_cpp"
"ac_fn_c_try_cpp" -> "ac_fn_c_check_type"
"ac_fn_c_check_type" -> "ac_fn_c_try_link"
"ac_fn_c_try_link" -> "ac_fn_c_check_func"
"ac_fn_c_check_func" -> "ac_fn_c_try_run"
"ac_fn_c_try_run" -> "ac_fn_c_check_member"
"ac_fn_c_check_member" -> "ac_fn_check_decl"
"ac_fn_check_decl" -> "ac_fn_c_compute_int"
"ac_fn_c_compute_int" -> "config.log"
"config.log" -> "C89"
"C89" -> "C99"
"C99" -> "C11"
"C11" -> "ac_aux_files"
"ac_aux_files" -> "config.sub"
"config.sub" -> "checking"
"checking" -> "confdefs.h"
"confdefs.h" -> "CFLAGS"
"CFLAGS" -> "grep"
...
"opendir" -> "kill"
"kill" -> "large files"
"large files" -> "HAVE_POSIX_SIGNALS"
"HAVE_POSIX_SIGNALS" -> "termcap"
"termcap" -> "HAVE_LANGINFO_CODESET"
"HAVE_LANGINFO_CODESET" -> "checking for wctype.h"
"checking for wctype.h" -> "C11"
"C11" -> "C11"
"C11" -> "C11"
"C11" -> "C11"
"C11" -> "C11"
...
- 找gcc
- gcc版本：遍历`--version -v -V -qversion -version`
...
- `export DUALCASE=1`  for MKS shell;如果DUALCASE为0，case语句和文件名产生是大小写不敏感的。如果不为零，则是大小写敏感的。
- shell开启posix兼容模式
- `as_nl` 换行
- 重置shell环境变量:
  - `IFS` 空格、制表符、换行
...
- 确定PATH分隔符
- `as_myself` 存在且可执行
- `exec $CONFIG_SHELL $as_opts "$as_myself" ${1+"$@"}` 开启子shell来执行
- `SHELL=/bin/sh`
- `unset CLICOLOR_FORCE GREP_OPTIONS`
- 防止重复执行的机制
- 定义兼容性测试代码
- 可执行文件检测函数：`as_fn_executable_p`
- 字符串追加优化函数
- 算术运算函数
- 错误处理函数：`as_fn_error STATUS ERROR [LINENO LOG_FD]`
- `expr`兼容性检测
- `basename/dirname` 检测
- `as_me=configure`
- 获取当前脚本名称
...
- 字符集定义
- 检测 echo 行为兼容性
- 符号链接与文件操作测试: `ln -s`,`mkdir -p`
- 变量名转换（Sed 表达式）
- 获取主机名：`ac_hostname`
- 默认安装路径: `ac_default_prefix=/usr/local`
- 标记是否交叉编译: `cross_compiling=no`
- 包信息（名称、版本、Bug 报告地址）:
  - `PACKAGE_NAME='readline'`
  - `PACKAGE_TARNAME='readline'`
  - `PACKAGE_VERSION='8.2'`
  ...
  - `PACKAGE_BUGREPORT='bug-readline@gnu.org'`
  - `PACKAGE_URL=''`
- 标识项目的唯一文件: `ac_unique_file="readline.h"`
- 默认的 C 头文件包含列表，用于后续的编译测试: `ac_includes_default`
- 列出所有需要在 Makefile 中替换的变量（通过 AC_SUBST 定义）: `ac_subst_vars`
- 定义脚本支持的配置选项: `ac_user_opts`
- 安装目录初始化:
- 命令行参数解析:
  - 路径选项（如 --prefix、--bindir）：直接赋值给对应变量。
  - 功能选项（如 --enable-shared、--with-curses）
  - 特殊选项: `--help --version --cache-file`
- 缺失参数检查
- 未识别选项处理
  - no：完全忽略未识别选项。
  - fatal：报错退出（默认行为）。
...
#### 1. shell开启posix兼容模式：`set -o posix`

```bash
2025-03-30T14:03:40 [igoodfu@48 /db/storage/guolicheng/bin] $ set -o
allexport      	off
braceexpand    	on
emacs          	on
errexit        	off
...
2025-03-30T14:19:24 [igoodfu@48 /db/storage/guolicheng/bin] $ set -o posix
2025-03-30T14:27:44 [igoodfu@48 /db/storage/guolicheng/bin] $ set -o
allexport      	off
braceexpand    	on
emacs          	on
errexit        	off
...
防止用户设置的复杂提示符（如包含颜色代码、动态信息）污染脚本输出或日志。
...
for as_var in BASH_ENV ENV MAIL MAILPATH CDPATH; do
	eval test \${$as_var+y} &&
...
- 重置`IFS`变量为空格、制表符、换行符，且该顺序不要改变
- 重置提示符变量
  - PS1：主提示符（默认交互式提示，如 username@host:~$）。
  - PS2：续行提示符（输入多行命令时显示，默认 >）。
  - PS4：调试提示符（set -x 时显示，默认 +）。
- 取消环境变量
  - BASH_ENV
  - ENV
  - MAIL
...
test \$(( 1 + 1 )) = 2 || exit 1"
	...
	if test x$as_have_required = xyes && (eval "$as_suggested") 2>/dev/null; then
		...
		IFS=$PATH_SEPARATOR
		as_found=false
		for as_dir in /bin$PATH_SEPARATOR/usr/bin$PATH_SEPARATOR$PATH; do
			IFS=$as_save_IFS
			case $as_dir in #(((
			'') as_dir=./ ;;
			*/) ;;
			...
			/*)
				for as_base in sh bash ksh sh5; do
					...
					if { test -f "$as_shell" || test -f "$as_shell.exe"; } &&
						as_run=a "$as_shell" -c "$as_bourne_compatible""$as_required" 2>/dev/null; then
						:
						CONFIG_SHELL=$as_shell as_have_required=yes
						if as_run=a "$as_shell" -c "$as_bourne_compatible""$as_suggested" 2>/dev/null; then
							:
							break 2
						fi
					fi
		...
		if $as_found; then
			...
			if { test -f "$SHELL" || test -f "$SHELL.exe"; } &&
				as_run=a "$SHELL" -c "$as_bourne_compatible""$as_required" 2>/dev/null; then
				:
...
# 判断是否为shell类型：zsh则处理参数传递，其他shell则启用 POSIX 兼容模式
#
DUALCASE=1
...
eval 'test "x$as_lineno_1'$as_run'" != "x$as_lineno_2'$as_run'" &&
  ...
  ' <$as_myself |
    ...
    ' >$as_me.lineno &&
		...
		{
			printf "%s\n" "$as_me: error: cannot create $as_me.lineno; rerun with a POSIX shell" >&2
			as_fn_exit 1
		}
...
for ac_var in exec_prefix prefix bindir sbindir libexecdir datarootdir \
	...
	libdir localedir mandir runstatedir; do
	eval ac_val=\$$ac_var
...
if test "$ac_init_help" = "recursive"; then
	...
	for ac_dir in : $ac_subdirs_all; do
		test "x$ac_dir" = x: && continue
		test -d "$ac_dir" ||
...
IFS=$PATH_SEPARATOR
as_found=false
for as_dir in $ac_aux_dir_candidates; do
	IFS=$as_save_IFS
	case $as_dir in #(((
	'') as_dir=./ ;;
	*/) ;;
	*) as_dir=$as_dir/ ;;
	...
	ac_install_sh=
	for ac_aux in $ac_aux_files; do
		# As a special case, if "install-sh" is required, that requirement
		# can be satisfied by any of "install-sh", "install.sh", or "shtool",
		# and $ac_install_sh is set appropriately for whichever one is found.
		if test x"$ac_aux" = x"install-sh"; then
...
if test ${with_shared_termcap_library+y}; then
	:
	withval=$with_shared_termcap_library
	opt_shared_termcap_lib=$withval
fi
...
if test ${enable_multibyte+y}; then
	:
...
if test ${enable_install_examples+y}; then
	:
	enableval=$enable_install_examples
	opt_install_examples=$enableval
fi

# Check whether --enable-bracketed-paste-default was given.
if test ${enable_bracketed_paste_default+y}; then
	:
	enableval=$enable_bracketed_paste_default
	opt_bracketed_paste_default=$enableval
fi
...
if eval test \${ac_cv_prog_make_${ac_make}_set+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test -n "$ac_tool_prefix"; then
	...
	set dummy ${ac_tool_prefix}gcc
	ac_word=$2
	{
		printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
		printf %s "checking for $ac_word... " >&6
	}
	if test ${ac_cv_prog_CC+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test -z "$ac_cv_prog_CC"; then
	...
	if test ${ac_cv_prog_ac_ct_CC+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test -z "$CC"; then
	if test -n "$ac_tool_prefix"; then
		for ac_prog in cl.exe; do
			...
			set dummy $ac_tool_prefix$ac_prog
			ac_word=$2
			{
				printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
				printf %s "checking for $ac_word... " >&6
...
if test -z "$CC"; then
	if test -n "$ac_tool_prefix"; then
		...
		set dummy ${ac_tool_prefix}clang
		ac_word=$2
		{
			printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
			printf %s "checking for $ac_word... " >&6
	...
	for ac_file in $ac_files ''; do
		...
		*.$ac_ext | *.xcoff | *.tds | *.d | *.pdb | *.xSYM | *.bb | *.bbg | *.map | *.inf | *.dSYM | *.o | *.obj) ;;
		...
		[ab].out)
			...
			;;
		*.*)
			if test ${ac_cv_exeext+y} && test "$ac_cv_exeext" != no; then :; else
...
if test ${ac_cv_c_compiler_gnu+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_prog_cc_g+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test x$ac_prog_cc_stdc = xno; then
	...
	if test ${ac_cv_prog_cc_c11+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test x$ac_prog_cc_stdc = xno; then
	...
	if test ${ac_cv_prog_cc_c99+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
_ACEOF
		for ac_arg in '' -std=gnu99 -std=c99 -c99 -qlanglvl=extc1x -qlanglvl=extc99 -AC99 -D_STDC_C99=; do
			CC="$ac_save_CC $ac_arg"
			if ac_fn_c_try_compile "$LINENO"; then
				:
...
if test x$ac_prog_cc_stdc = xno; then
	...
	if test ${ac_cv_prog_cc_c89+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
_ACEOF
		for ac_arg in '' -qlanglvl=extc89 -qlanglvl=ansi -std -Ae "-Aa -D_HPUX_SOURCE" "-Xc -D__EXTENSIONS__"; do
			CC="$ac_save_CC $ac_arg"
			if ac_fn_c_try_compile "$LINENO"; then
				:
...
ac_header= ac_cache=
for ac_item in $ac_header_c_list; do
...
if test ${ac_cv_safe_to_define___extensions__+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_should_define__xopen_source+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test -z "$CPP"; then
	if test ${ac_cv_prog_CPP+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
		# Double quotes because $CC needs to be expanded
		for CPP in "$CC -E" "$CC -E -traditional-cpp" cpp /lib/cpp; do
			ac_preproc_ok=false
...
if test ${ac_cv_path_GREP+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
	if test -z "$GREP"; then
		...
		as_save_IFS=$IFS
		IFS=$PATH_SEPARATOR
		for as_dir in $PATH$PATH_SEPARATOR/usr/xpg4/bin; do
			IFS=$as_save_IFS
			case $as_dir in #(((
			'') as_dir=./ ;;
			*/) ;;
...
if test ${ac_cv_path_EGREP+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test $ac_cv_c_compiler_gnu = yes; then
	...
	if test ${ac_cv_prog_gcc_traditional+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
						...
						if as_fn_executable_p "$as_dir$ac_prog$ac_exec_ext"; then
							if test $ac_prog = install &&
								...
								if "$as_dir$ac_prog$ac_exec_ext" -c conftest.one conftest.two "$(pwd)/conftest.dir/" &&
									...
									test -s conftest.dir/conftest.two; then
...
if test -n "$ac_tool_prefix"; then
	...
	set dummy ${ac_tool_prefix}ar
	ac_word=$2
	{
		printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
		printf %s "checking for $ac_word... " >&6
	}
	if test ${ac_cv_prog_AR+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test -z "$ac_cv_prog_AR"; then
	...
	if test ${ac_cv_prog_ac_ct_AR+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test -n "$ac_tool_prefix"; then
	...
	set dummy ${ac_tool_prefix}ranlib
	ac_word=$2
	{
		printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
		printf %s "checking for $ac_word... " >&6
	}
	if test ${ac_cv_prog_RANLIB+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test -z "$ac_cv_prog_RANLIB"; then
	...
	if test ${ac_cv_prog_ac_ct_RANLIB+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test ${ac_cv_c_char_unsigned+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_c_volatile+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_header_stat_broken+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
for ac_hdr in dirent.h sys/ndir.h sys/dir.h ndir.h; do
	...
	if eval test \${$as_ac_Header+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test $ac_header_dirent = dirent.h; then
	...
	if test ${ac_cv_search_opendir+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test "x$ac_cv_func_isxdigit" = xyes; then
	:
...
if test "x$ac_cv_func_getpwent" = xyes; then
	:
...
if test ${ac_cv_type_uid_t+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_func_chown_works+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_func_strcoll_works+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test "x$ac_cv_header_sys_pte_h" = xyes; then
	:
...
if test "x$ac_cv_header_sys_stream_h" = xyes; then
	:
...
if test ${enable_largefile+y}; then
	:
...
if test "$enable_largefile" != no; then
	...
	if test ${ac_cv_sys_largefile_CC+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
_ACEOF
	...
	if test ${ac_cv_sys_file_offset_bits+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
_ACEOF
	...
	*)
	...
	if test $ac_cv_sys_file_offset_bits = unknown; then
		...
		if test ${ac_cv_sys_large_files+y}; then
			:
			printf %s "(cached) " >&6
		else
			$as_nop
...
if test ${bash_cv_signal_vintage+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop

	if test ${bash_cv_posix_signals+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
_ACEOF
	...
	if test $bash_cv_posix_signals = yes; then
		...
		if test ${bash_cv_bsd_signals+y}; then
			:
			printf %s "(cached) " >&6
		else
			$as_nop
...
_ACEOF
		...
		if test $bash_cv_bsd_signals = yes; then
			...
			if test ${bash_cv_sysv_signals+y}; then
				:
				printf %s "(cached) " >&6
			else
				$as_nop
...
if test ${bash_cv_must_reinstall_sighandlers+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_func_sigsetjmp+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_func_lstat+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_func_strcoll_broken+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_getpw_declared+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_sys_tiocgwinsz_in_termios_h+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test $ac_cv_sys_tiocgwinsz_in_termios_h != yes; then
	...
	if test ${ac_cv_sys_tiocgwinsz_in_sys_ioctl_h+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test ${ac_cv_have_sig_atomic_t+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_tiocstat_in_ioctl+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_fionread_in_ioctl+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_speed_t_in_sys_types+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_struct_winsize_header+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop

	if test ${bash_cv_struct_winsize_ioctl+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
_ACEOF
	...
	if test ${bash_cv_struct_winsize_termios+y}; then
		:
		printf %s "(cached) " >&6
	else
		$as_nop
...
if test ${bash_cv_dirent_has_d_ino+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_dirent_has_d_fileno+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_struct_timeval+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_c_undeclared_builtin_options+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_termcap_lib+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
	...
	if test "x$ac_cv_func_tgetent" = xyes; then
		...
		if test ${ac_cv_lib_termcap_tgetent+y}; then
			:
			printf %s "(cached) " >&6
		else
			$as_nop
...
_ACEOF
		...
		if test "x$ac_cv_lib_termcap_tgetent" = xyes; then
			...
			if test ${ac_cv_lib_tinfo_tgetent+y}; then
				:
				printf %s "(cached) " >&6
			else
				$as_nop
...
_ACEOF
			...
			if test "x$ac_cv_lib_tinfo_tgetent" = xyes; then
				...
				if test ${ac_cv_lib_curses_tgetent+y}; then
					:
					printf %s "(cached) " >&6
				else
					$as_nop
...
_ACEOF
				...
				if test "x$ac_cv_lib_curses_tgetent" = xyes; then
					...
					if test ${ac_cv_lib_ncurses_tgetent+y}; then
						:
						printf %s "(cached) " >&6
					else
						$as_nop
...
_ACEOF
					...
					if test "x$ac_cv_lib_ncurses_tgetent" = xyes; then
						...
						if test ${ac_cv_lib_ncursesw_tgetent+y}; then
							:
							printf %s "(cached) " >&6
						else
							$as_nop
...
if test ${am_cv_langinfo_codeset+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_func_mbrtowc+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test "x$ac_cv_func_iswctype" = xyes; then
	:
...
if test ${bash_cv_type_wchar_t+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_type_wctype_t+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_type_wint_t+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${bash_cv_wcwidth_broken+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test ${ac_cv_sizeof_wchar_t+y}; then
	:
	printf %s "(cached) " >&6
else
	$as_nop
...
if test -f ${srcdir}/support/shobj-conf; then
	{
		printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking configuration for building shared libraries" >&5
	...
	*) SHLIB_LIBS="$SHLIB_LIBS $SHARED_TERMCAP" ;;
	...
	{
		printf "%s\n" "$as_me:${as_lineno-$LINENO}: result: $SHLIB_STATUS" >&5
		printf "%s\n" "$SHLIB_STATUS" >&6
	}
...
ac_ltlibobjs=
U=
for ac_i in : $LIBOBJS; do
	test "x$ac_i" = x: && continue
