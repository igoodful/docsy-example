...
public:
        ...
        void sort() {
                ...
                std::sort(m_rsegs.begin(), m_rsegs.end(), [](trx_rseg_t *lhs, trx_rseg_t *rhs) {
        ...
        bool is_inactive_implicit() {
                return (m_state == INACTIVE_IMPLICIT);
        }
        ...
        bool is_inactive_explicit() {
                return (m_state == INACTIVE_EXPLICIT);
        }
        ...
        can be dropped. */
        void set_empty() {
                ut_ad(m_state == INACTIVE_EXPLICIT || m_state == ACTIVE || m_state == INIT || m_state == EMPTY);
                m_state = EMPTY;
        }
