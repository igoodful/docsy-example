...
### /etc/sysctl.conf
> 一定要保证coredump文件路径存在，否则不会生成文件：/data/coredump
>
> 不仅目录存在，而且路径权限要高，最好777
...
- 方法1
```bash
2024-11-08T17:50:56 [root@x86centos7-101 /tmp] # cat /proc/sys/kernel/core_pattern
core
2024-11-08T17:56:55 [root@x86centos7-101 /data/app/dbscale] # cat /proc/sys/kernel/core_pattern
/tmp/%e.core.%p
```
