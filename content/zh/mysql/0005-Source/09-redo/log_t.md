...
| :-------- | :------------------ | :--- |
| `m_latch` | `rw_lock_t *`       |      |
| `m_state` | `undo_space_states` |      |
| `m_rsegs` | `Rsegs_Vector`      |      |
...
struct alignas(ut::INNODB_CACHE_LINE_SIZE) log_t {
        ...
        alignas(ut::INNODB_CACHE_LINE_SIZE) ut::aligned_array_pointer<byte, LOG_BUFFER_ALIGNMENT> buf;
        ...
        alignas(ut::INNODB_CACHE_LINE_SIZE) std::atomic<uint64_t> write_to_file_requests_total;
        ...
        alignas(ut::INNODB_CACHE_LINE_SIZE) std::atomic<std::chrono::microseconds> write_to_file_requests_interval;
