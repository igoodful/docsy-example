---
title: memory_summary_by_host_by_event_name
description: 从host角度统计内存信息
date: 2024-10-09
weight: 20000
---
...
```sql
[root@127.0.0.1:8032 10:01:33(performance_schema)]$ show create table memory_summary_by_host_by_event_name\G
*************************** 1. row ***************************
       Table: memory_summary_by_host_by_event_name
Create Table: CREATE TABLE `memory_summary_by_host_by_event_name` (
